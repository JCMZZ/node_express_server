...
function openAddBox() {
	...
	html += '<dt><label>用户名:</label><input type="text" id="addUsername" autocomplete="off" value=""/></dt>';
	html += '<dt><label>登录密码:</label><input type="password" autocomplete="off" id="password" value=""/></dt>';
