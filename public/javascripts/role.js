		...
		success:function(data){	
			...
			for(var i in ngvs){
				...
				for(var j in pages){
					...
					html += '<p style="margin-left:20px;margin-top:5px;color:black;">' + pageName + '<input type="checkbox" stype="page" id="'+pageId+'"  class="checkboxdo"/></p>';
					...
					for(var k in opers){
						...
						html += '<input type="checkbox" id="'+operId+'" stype="oper" style="margin:0px 5px 0px 10px;" class="checkboxdo"/>' + operName ;
					...
					success:function(data){	
						...
						for(var i in ngvs){
							...
							for(var j in pages){
								...
								var pageId = page.id;
								var pageName = page.name;
								html += '<p style="margin-left:20px;margin-top:5px;color:black;">' + pageName + '<input type="checkbox" stype="page" id="'+pageId+'"  class="checkboxdo" ';
								...
								for(var k in opers){
									...
									var operId = oper.id;
									var operName = oper.name;
									html += '<input type="checkbox" id="'+operId+'" stype="oper" style="margin:0px 5px 0px 10px;" class="checkboxdo"';
